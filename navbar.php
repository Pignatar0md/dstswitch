<nav class="navbar navbar-inverse" role="navigation">
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <!-- <li><a href="views/Group/NewGroup.php">Alta</a></li>
                                    <li><a href="views/Group/ListGroup.php">Listado</a></li>-->
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <img id="logo" src="static/img/logo-freetech-solutions.png" style="width: 120px; height: 45px"/>
                        </ul>
                    </div>
                </nav>