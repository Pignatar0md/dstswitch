...
<script>
    $(document).ready(function () {
        ...
        $("#tablaBilling").on('click', '.eliminar', function (e) {
...
<div class="row"><br>
    <div class="col-md-3 col-md-offset-4">
        <table class="table table-striped">
            <thead><th>#</th><th>Tarifas</th><th style="text-align: center">Acciones</th></thead>
            <tbody id="tablaBilling"></tbody>
        </table>
    </div>
</div>
